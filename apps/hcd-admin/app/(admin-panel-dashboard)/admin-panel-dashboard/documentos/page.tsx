          ...
          <div
            ...
            onClick={() => {
              if (tipo.value === "ordenanza") {
                router.push("/admin-panel-dashboard/documentos/editar/ordenanza");
              } else {
                router.push(`/admin-panel-dashboard/documentos/${tipo.value}`);
              }
            }}
          >
            ...
            <div className="flex gap-2">
              <Button
                onClick={e => {
                  e.stopPropagation();
                  router.push(`/admin-panel-dashboard/documentos/nuevo?tipo=${tipo.value}`);
                }}
                className="ml-4"
              >
                Crear
