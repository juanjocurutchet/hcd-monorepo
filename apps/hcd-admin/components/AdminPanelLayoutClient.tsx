...
export default function AdminPanelLayoutClient({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "Concejales", href: "/admin-panel-dashboard/concejales", icon: <User className="h-5 w-5" /> },
    { name: "Bloques", href: "/admin-panel-dashboard/bloques", icon: <Users className="h-5 w-5" /> },
    { name: "Comisiones", href: "/admin-panel-dashboard/comisiones", icon: <Layers className="h-5 w-5" /> },
    { name: "Actividades", href: "/admin-panel-dashboard/actividades", icon: <Activity className="h-5 w-5" /> },
    { name: "Contactos", href: "/admin-panel-dashboard/contactos", icon: <Mail className="h-5 w-5" /> },
    { name: "Usuarios", href: "/admin-panel-dashboard/usuarios", icon: <UserPlus className="h-5 w-5" /> },
  ]
